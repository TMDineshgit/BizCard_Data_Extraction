...
mydb =sql.connect(host="127.0.0.1",
                   user="root",
                   password="rPWDmini_db",
                   database= "imageextracted_details",
                   port = "3306"
                  )
mycursor = mydb.cursor(buffered=True)

#mycursor.execute("CREATE DATABASE imageextracted_details")

#mycursor.execute("USE DATABASE imageextracted_details")
